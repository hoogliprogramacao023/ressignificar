<?php
    ...
    $puxaBanners = $banner->rsDados(27);
    $descServico = $servico->rsDados(2);
?>
                            ...
                            <div class="service-details__content">
                                ...
                                <img src="https://via.placeholder.com/770x445" class="img-fluid" alt="">
                                    ...
                                    <ul class="servicos-list">
                                        ...
                                        <li><?php echo $descServico->item11;?></li>
                                        <li><?php echo $descServico->item12;?></li>
                                        <li><?php echo $descServico->item13;?></li>
                                        <li><?php echo $descServico->item14;?></li>
                                    </ul>
