	...
	class Sobre {
		...
		function editar($redireciona='sobre.php') {
			if(isset($_POST['acao']) && $_POST['acao'] == 'editaSobre') {
				...
				if(isset($_POST['tem_descricao2']) && !empty($_POST['tem_descricao2'])){
					$tem_descricao2 = $_POST['tem_descricao2'];
				}else{
					$tem_descricao2 = '';	
				}
				if(isset($_POST['tem_titulo5_sessao1']) && !empty($_POST['tem_titulo5_sessao1'])){
					$tem_titulo5_sessao1 = $_POST['tem_titulo5_sessao1'];
				}else{
					$tem_titulo5_sessao1 = '';	
				}
				if(isset($_POST['tem_breve_sobre2']) && !empty($_POST['tem_breve_sobre2'])){
					$tem_breve_sobre2 = $_POST['tem_breve_sobre2'];
				}else{
					$tem_breve_sobre2 = '';	
				}
