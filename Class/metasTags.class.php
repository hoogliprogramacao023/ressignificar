	...
	class MetasTags {
		...
		function rsDados() {
			...
			try{   
				...
				$this->meta_description_convenio = $rsDados[0]->meta_description_convenio;
				$this->meta_title_convenio = $rsDados[0]->meta_title_convenio;
				$this->meta_keywords_sucesso = $rsDados[0]->meta_keywords_sucesso;
				$this->meta_description_sucesso = $rsDados[0]->meta_description_sucesso;
				$this->meta_title_sucesso = $rsDados[0]->meta_title_sucesso;
	...
	function editarMetaTag() {
			if(isset($_POST['acao']) && $_POST['acao'] == 'editarMetaTag') {
				...
				try{   
					...
					$stm->bindValue(38, $meta_description_sucesso);
					$stm->bindValue(39, $meta_keywords_sucesso);
					$stm->bindValue(40, $meta_title_sucesso);
					$stm->bindValue(41, 1);
					$stm->execute(); 
