...
if(empty($sessao1Instanciada)) {
	...
	class sessao1 {
		...
		public static function getInstance($conexao){   
			if (!isset(self::$sessao1)):    
				self::$sessao1 = new sessao1($conexao);   
			endif;
			return self::$sessao1;    
		}
		...
		function rsDados($id='', $orderBy='', $limite='', $destaque='', $categoria='') {
			...
			try{   
				$sql = "SELECT * FROM tbl_sessao1 where 1=1 $sql $sqlOrdem $sqlLimite";
		...
		function editar($redireciona='sessao1.php') {
