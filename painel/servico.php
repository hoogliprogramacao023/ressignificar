                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="." class="text-muted">Seção 4</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $servico->servico1;?></td>
                                                <td><?php echo $servico->servico2;?></td>
                                                <td>
                                                    <a href="editar-servico.php?id=<?php echo $servico->id;?>" class="btn btn-success btn-circle"><i class="fas fa-pencil-alt"></i></a>
                                                    <a href="servico.php?id=<?php echo $servico->id;?>&acao=excluirServico" class="btn btn-warning btn-circle"><i class="fa fa-times"></i></a>
                                                </td>
                                            </tr>
                                            <?php } }?>
                                        </tbody>
