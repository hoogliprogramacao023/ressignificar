  ...
  <div class="col-md-3 col-sm-12">
   ...
   <div class="form-group row">
    ...
    <label  class="col-form-label">Conteúdo 2</label>
     <textarea name="conteudo2" class="ckeditor" id="ckeditor" cols="30" rows="10"></textarea>
    </div>
   ...
   <div class="form-group row">
    ...
    <label  class="col-form-label">Conteúdo 3</label>
     <textarea name="conteudo3" class="ckeditor" id="ckeditor" cols="30" rows="10"></textarea>
    </div>
