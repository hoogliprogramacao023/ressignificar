                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12 col-sm-12">
                                                <label  class="col-form-label">Texto Sobre - Footer</label>
                                                <textarea name="texto_sobre" class="ckeditor" id="ckeditor" cols="30" rows="10"><?php if(isset($editaConfig->texto_sobre) && !empty($editaConfig->texto_sobre)){ echo $editaConfig->texto_sobre;}?></textarea>
                                            </div>
                                        </div>  
                                        <hr>
                                        <div class="form-group">
