...
<div class="form-group row">
    ...
    <label  class="col-form-label">Link especialista</label>
     <input class="form-control" type="text" name="graduacao" id="kt_inputmask_3" />
    </div>
   ...
   <div class="form-group row">
    ...
    <label  class="col-form-label">Titulo 2</label>
     <input class="form-control" type="text" name="titulo2" />
    </div>   
   </div>
    <div class="form-group row">
    <div class="col-md-12 col-sm-12">
    <label  class="col-form-label">Breve 2</label>
     <input class="form-control" type="text" name="breve2" />
    </div>   
   </div>
    <div class="form-group row">
    <div class="col-md-6 col-sm-12">
    <label  class="col-form-label">Titulo 1</label>
     <input class="form-control" type="text" name="titulo3" />
    </div>   
     <div class="col-md-6 col-sm-12">
    <label  class="col-form-label">Porcentagem 1</label>
     <input class="form-control" type="text" name="titulo4" />
    </div> 
   </div>
    <div class="form-group row">
    <div class="col-md-6 col-sm-12">
    <label  class="col-form-label">Titulo 2</label>
     <input class="form-control" type="text" name="titulo5" />
    </div>   
     <div class="col-md-6 col-sm-12">
    <label  class="col-form-label">Porcentagem 2</label>
     <input class="form-control" type="text" name="titulo6" />
    </div> 
   </div>
   <div class="form-group row">
    <div class="col-md-6 col-sm-12">
    <label  class="col-form-label">Titulo 3</label>
     <input class="form-control" type="text" name="titulo7" />
    </div>   
     <div class="col-md-6 col-sm-12">
    <label  class="col-form-label">Porcentagem 3</label>
     <input class="form-control" type="text" name="titulo8" />
    </div> 
   </div>
