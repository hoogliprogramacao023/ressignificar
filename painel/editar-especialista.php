...
<body>
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <!-- <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                            <label  class="col-form-label">Foto Descrição Especialista </label>
                                                <input class="form-control" type="file" name="foto_1"  />
                                            </div>
                                            <?php if(isset($puxaDoutor->foto_1) && !empty($puxaDoutor->foto_1)){?>
                                            <div class="col-md-4 col-sm-12">
                                            <img src="../img/<?php echo $puxaDoutor->foto_1;?>" width="100">
                                            </div>
                                            <?php }?>
   ...
   <div class="form-group row">
      <div class="col-md-3 col-sm-12">
        <label  class="col-form-label">Link especialista</label>
        <input class="form-control" type="text" name="graduacao" value="<?php if(isset($puxaDoutor->graduacao) && !empty($puxaDoutor->graduacao)){ echo $puxaDoutor->graduacao;}?>" />
      </div>
   </div>
   <div class="form-group row">
    ...
    <label  class="col-form-label">Currículo</label>
     ...
     <div class="form-group row">
        ...
        <label  class="col-form-label">Titulo 2</label>
         <input class="form-control" type="text" name="titulo2" value="<?php if(isset($puxaDoutor->titulo2) && !empty($puxaDoutor->titulo2)){ echo $puxaDoutor->titulo2;}?>" />
        </div>  
        </div>
        ...
        <label  class="col-form-label">Breve 2</label>
         <textarea name="breve2" class="ckeditor" id="ckeditor" cols="30" rows="10"><?php if(isset($puxaDoutor->breve2) && !empty($puxaDoutor->breve2)){ echo $puxaDoutor->breve2;}?></textarea>
        </div>
        </div>
    </div>
    <div class="form-group row">
        ...
        <label  class="col-form-label">Titulo 1</label>
         <input class="form-control" type="text" name="titulo3" value="<?php if(isset($puxaDoutor->titulo3) && !empty($puxaDoutor->titulo3)){ echo $puxaDoutor->titulo3;}?>" />
        </div>
        <div class="col-md-6 col-sm-12">
        <label  class="col-form-label">Porcentagem 1</label>
         <input class="form-control" type="text" name="titulo4" value="<?php if(isset($puxaDoutor->titulo4) && !empty($puxaDoutor->titulo4)){ echo $puxaDoutor->titulo4;}?>" />
        </div>
        </div>
 <div class="form-group row">
        <div class="col-md-6 col-sm-12">
        <label  class="col-form-label">Titulo 2</label>
         <input class="form-control" type="text" name="titulo5" value="<?php if(isset($puxaDoutor->titulo5) && !empty($puxaDoutor->titulo5)){ echo $puxaDoutor->titulo5;}?>" />
        </div>
        <div class="col-md-6 col-sm-12">
        <label  class="col-form-label">Porcentagem 2</label>
         <input class="form-control" type="text" name="titulo6" value="<?php if(isset($puxaDoutor->titulo6) && !empty($puxaDoutor->titulo6)){ echo $puxaDoutor->titulo6;}?>" />
        </div>
        </div>
       ...
       <div class="form-group row">
        ...
        <label  class="col-form-label">Titulo 3</label>
         <input class="form-control" type="text" name="titulo7" value="<?php if(isset($puxaDoutor->titulo7) && !empty($puxaDoutor->titulo7)){ echo $puxaDoutor->titulo7;}?>" />
        </div>
        	<div class="col-md-6 col-sm-12">
        <label  class="col-form-label">Porcentagem 3</label>
         <input class="form-control" type="text" name="titulo8" value="<?php if(isset($puxaDoutor->titulo8) && !empty($puxaDoutor->titulo8)){ echo $puxaDoutor->titulo8;}?>" />
        </div>
        </div>
...
<div class="col-md-12">	   
   ...
   <div class="form-group row">
	...
	<textarea name="meta_description" class="form-control" id="" cols="30" rows="10"><?php if(isset($puxaDoutor->meta_description) && !empty($puxaDoutor->meta_description)){ echo $puxaDoutor->meta_description;}?></textarea> 
                                    ...
                                    <input type="hidden" name="foto_1_Atual" value="<?php echo $puxaDoutor->foto_1;?>">
